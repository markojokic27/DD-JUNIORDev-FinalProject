...
function SelectInput(props) {
  ...
  const [selectedOptions, setSelectedOptions] = useState(props.selectedCourse[props.name] || []);
  ...
  const handleOptionClick = (optionId) => {
    ...
    props.setSelectedCourse({ ...props.selectedCourse, [props.name]: updatedOptions });
